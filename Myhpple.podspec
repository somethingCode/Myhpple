#
#  Be sure to run `pod spec lint Myhpple.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.authors            = { "somethingCode" => "email@address.com" }
  ...
  s.source       = { :git => "https://github.com/somethingCode/Myhpple.git", :tag => "0.0.3" }
